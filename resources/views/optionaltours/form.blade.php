...
@endif
{!! Form::open(array(
    'url'=>'optionaltours/save/'.SiteHelpers::encryptID($row['optionaltourID']?$row['optionaltourID']:0),
    'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'optionaltoursFormAjax')) !!}
			<div class="col-md-12">
						<fieldset>
							<legend> {{ Lang::get('core.optionaltours') }}</legend>
