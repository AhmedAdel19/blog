...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'suppliers/save/'.SiteHelpers::encryptID($row['supplierID']?$row['supplierID']:0), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'suppliersFormAjax')) !!}
			<div class="col-md-12">
