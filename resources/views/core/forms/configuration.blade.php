...
{{--todo add this button after fixing the related bugs--}}
<button type="button" onclick="MmbModal('{{ url("core/forms/input/".$row->formID) }}','New Input')"
		class="btn  btn-warning btn-sm" ><i class="fa fa-list-ul fa-2x"></i>
	New Field
</button>
